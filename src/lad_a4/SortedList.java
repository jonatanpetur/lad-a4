...
// Hint: To create an array of type E[], use E[] arr = (E[]) new Comparable[arraysize];
    ...
    // Challenge: can you have a log N add, if you are also allowed to have a log N get?
    ...
    // Hint: look in the TestList.java file to see am example of how this is expected to work
    ...
    //Challenge: Can you avoid copy-pasting too much code from firstIndex? (i.e. Move the code from both into a first/last-index method or such?) 
