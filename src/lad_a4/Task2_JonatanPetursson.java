 ...
 */
public class Task2_JonatanPetursson<E extends Comparable<E>> implements SortedList<E> {
    ...
    /**
     * This hash code has for its worse case complexity in case of a list with Strings O(count + M) where count is the quantity of elements in the list
     * and M is the String size. Assuming that the String size is a constant we can say the method has O(count).
     * The method loops the list getting the hash for each element in the list and return the list's hashCode. If the list is empty
     * then it will return the zero value which is the hashcode value for null.
     * @return
     */
    @Override
    public int hashCode(){
        ...
        if(count > 0){
            for( int i = 0; i < count; i++) {
                hashCode = hashCode ^ this.get(i).hashCode();
            }
        }
    ...
    /**
     *  Worse case complexity here is O(count) where count is the quantity of elements in the list. The method will check
     *  both elements hashcode and compare them also comparing if the element passed as parameter belongs to the right class. It will
     *  return true if the elements have the same hashcode and false if not.
     * @param o
     * @return
     */
    @Override
    public boolean equals(Object o) {
        ...
        Task2_JonatanPetursson list = (Task2_JonatanPetursson) o;
        return this.hashCode() == list.hashCode() && o instanceof Task2_JonatanPetursson;
    }
