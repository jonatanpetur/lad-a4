 ...
 * Updated by Axel on 3/10/2016.
 */
public class Task2_AxelVerner<E extends Comparable<E>> implements SortedList<E> {
    ...
    /**
     * Following hashCode() method hashes the values from the given list of words "avt2" and returns the hashCode.
    ...
    public int hashCode(){
        int hashCode = 0;
            for(int i = 0; i < count; i++){
                hashCode = 92821*hashCode + this.get(i).hashCode();
            }
    ...
    /**
     *  Worst case complexity here is O(count) where count is the quantity of elements in the list. The method will check
    ...
    public boolean equals(Object o) {
        ...
        Task2_AxelVerner list = (Task2_AxelVerner) o;
        return this.hashCode() == list.hashCode() && o instanceof Task2_AxelVerner;
    }
