 ...
 */
public class Task2_GeoffreyChen<E extends Comparable<E>> implements SortedList<E> {
    ...
    public int hashCode(){
        ...
        if(count > 0) {
            for (int i = 0; i < count; i++) {
                hashCode = hashCode * 63 ^ this.get(i).hashCode();
            }
        }
    ...
    public boolean equals(Object o) {
        ...
        Task2_GeoffreyChen list = (Task2_GeoffreyChen) o;
        return this.hashCode() == list.hashCode() && o instanceof Task2_GeoffreyChen;
    }
